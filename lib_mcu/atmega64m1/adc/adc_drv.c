 ...
 * adc_drv.c
    ...
    The contents of this file were originally from the ADC Software Library 
    provided by Atmel. Use of this file is subject to Atmel's End User 
    License Agreement.
    
     Modified for atmega64m1
...
//!          ADC I/O pin must be initialized before calling this function
//!
...
U16 adc_single_conversion(U8 adc_input_pin)
{
    ...
    if(adc_input_pin < 8) ADC_DID_REG  |=  (1<<adc_input_pin);
	else{
		switch(adc_input_pin){
			case 8:
				ADC_DID_REG2 |= (1<<ADC8D);
				break;
			case 9:
				ADC_DID_REG2 |= (1<<ADC9D);
				break;
			case 10:
				ADC_DID_REG2 |= (1<<ADC10D);
				break;
		}
	}        
