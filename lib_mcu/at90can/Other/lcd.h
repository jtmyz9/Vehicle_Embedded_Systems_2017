...
/**
 @brief    Add a Custom character to the the character set
 @param    character number, Pointer to program memory where the data is stored
 @return   none
*/

extern void lcd_add_char(uint8_t char_num,uint8_t *progmem_s);
