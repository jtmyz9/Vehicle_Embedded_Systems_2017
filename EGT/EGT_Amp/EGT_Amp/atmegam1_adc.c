...
#endif	 
	 //Disable digital input buffer on corresponding ADC pin
	 // --- First 8 ADC channels are located in DIDR0
	 // --- 8,9,10 in DIDR2
	if(adc_input_pin  < 8) DIDR0  |=  (1<<adc_input_pin);
	else{
